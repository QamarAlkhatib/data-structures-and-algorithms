...
const addExclamation = (arr) => {
  ...
  arr.forEach(element => {
    let addingString = element + '!';
    stringArray.push(addingString);
  });
  return stringArray;
};
...
const allUpperCase = (arr) => {
  ...
  let newArray = [];
  arr.forEach(element => {
    let StringToUpperCase = element.toUpperCase();
    newArray.push(StringToUpperCase);
  });
  return newArray;
};
...
const greeting = (word) => {
  ...
  let StringUpperCase = word.toUpperCase() + '!';
...
const speaker = (words, callback) => {
  ...
  words.forEach(element => {
    let newString = callback(element);
...
const addNumbers = (num, arr, times, callback) => {
  ...
  // to invoke the callback function based on the times number;
