...
const isCapitalized = (str) => {
  // Solution code here...
  let contain =  /\b[A-Z](\w*)/g;
  return str.match(contain) || [];
};
...
const citiesAtoJ = (arr) => {
  // Solution code here...
  let contain =  /b[A-J]w*/g;
  return arr.filter(value => contain.test(value));
};
