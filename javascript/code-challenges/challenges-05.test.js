...
const addValues = (arr) => {
  // Solution code here...
  let newArray = arr.reduce((acc, val) => acc += val, 0);
  return newArray;
};
...
const addPurchases = (arr) => {
  // Solution code here...
  let newArray = arr.reduce((acc, val) => acc += val.purchasePrice, 0);
  return newArray;
};
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  let newArray = arr.reduce((acc) => acc + 1, 0);
  return newArray;
...
const returnNames = (arr) => {
  // Solution code here...
  let newArray = arr.reduce(function (pV, cV) {
    pV.push(cV.name);
    return pV;
  }, []);
  return newArray;
};
// source of understanding https://stackoverflow.com/questions/35431292/using-the-reduce-function-to-return-an-array
...
const countNumberOfChildren = (arr) => {
  // Solution code here...
  let newArray = arr.reduce((acc) => acc.children.length);
  return newArray;
};
